                        ...
                        for (var c = [], d = !0, e = 0; e < a.length; e += 2)
                            void 0 === b[e / 2].value
                                ...
                                : (d &&
                                      ...
                                      (d = !1)),
                                  c[c.length - 1].pathCoordinates.push(
                                      a[e],
                                      a[e + 1]
                                  ),
                    ...
                    return function g(a, d) {
                        ...
                        for (
                            ...
                            j
                                ...
                                : l || (n[0] = { x: +a[l], y: +a[l + 1] }),
                                k.curve(
                                    (e * (-n[0].x + 6 * n[1].x + n[2].x)) / 6 +
                                        f * n[2].x,
                                    (e * (-n[0].y + 6 * n[1].y + n[2].y)) / 6 +
                                        f * n[2].y,
                                    (e * (n[1].x + 6 * n[2].x - n[3].x)) / 6 +
                                        f * n[2].x,
                                    (e * (n[1].y + 6 * n[2].y - n[3].y)) / 6 +
                                        f * n[2].y,
                                    n[2].x,
                                    n[2].y,
                                    !1,
        ...
        (function (a, b, c) {
            ...
            function e(a) {
                ...
                for (var o = 0; o < this.data.series.length; o++) {
                    ...
                    if (
                        (u.attr(
                            { value: l[o], meta: c.serialize(p.meta) },
                            c.xmlNs.uri
                        ),
                        a.donut &&
                            u.attr({
