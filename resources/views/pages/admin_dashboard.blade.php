@extends('layouts.app', ['activePage' => 'admin_dashboard', 'title' => 'Thai-Tanic', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-8">
                    <div class="card ">
                        ...
                        <div class="card-footer ">
                            ...
                            <hr>
                            <div class="stats">
                                <i class="fa fa-history"></i> {{ __('Updated 2 minutes ago') }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card ">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('2022 Sales') }}</h4>
                        ...
                        <div class="card-footer ">
                            <div class="legend">
                                <i class="fa fa-circle text-info"></i> {{ __('Sushi') }}
                                <i class="fa fa-circle text-danger"></i> {{ __('Salad') }}
                            </div>
                            <hr>
                            <div class="stats">
                ...
                <div class="col-md-6">
                    <div class="card  card-tasks">
                        <div class="card-header ">
                            ...
                            <p class="card-category">{{ __('Status') }}</p>
                        </div>
                        <div class="card-body ">
                        ...
                        <div class="card-footer ">
                            <hr>
                            <div class="stats">
                                <i class="now-ui-icons loader_refresh spin"></i> {{ __('Updated 1 minute ago') }}
                            </div>
                        </div>
                    </div>
                </div>
